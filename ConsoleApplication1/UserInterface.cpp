...
void initStaticTorquePanel(GLUI *menu)
{
	...
	forcex->set_alignment(GLUI_ALIGN_RIGHT);
	forcey->set_alignment(GLUI_ALIGN_RIGHT);
	forcez->set_alignment(GLUI_ALIGN_RIGHT);
	tor1->set_alignment(GLUI_ALIGN_RIGHT);
	tor2->set_alignment(GLUI_ALIGN_RIGHT);
	tor3->set_alignment(GLUI_ALIGN_RIGHT);
}
...
void initGUI (const int main_window, float DHParam[][4], float invKinParam[3]) {
	...
	box1 = menu->add_spinner_to_panel(panel1, "Arm Orient [25, 155] ", GLUI_EDITTEXT_FLOAT, &DHParam[0][0], 0, panelHandler);
	box2 = menu->add_spinner_to_panel(panel1, "Theta 1 [0, 50] ", GLUI_EDITTEXT_FLOAT, &DHParam[1][2], 0, panelHandler);
	box3 = menu->add_spinner_to_panel(panel1, "Theta 2 [0, 85] ", GLUI_EDITTEXT_FLOAT, &DHParam[2][2], 2, panelHandler);
	box4 = menu->add_spinner_to_panel(panel1, "Theta 3 [0, 120] ", GLUI_EDITTEXT_FLOAT, &DHParam[3][2], 3, panelHandler);
	...
	panel2 = menu->add_panel("Absolute Coords");
	...
	xpos->set_alignment(GLUI_ALIGN_RIGHT);
	ypos->set_alignment(GLUI_ALIGN_RIGHT);
	zpos->set_alignment(GLUI_ALIGN_RIGHT);
